...
public class VerifikasiPetaniActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(VerifikasiPetaniActivity.this);
        ...
        verificationCallbacks =
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        ...
                        Toast.makeText(VerifikasiPetaniActivity.this, "Nomor salah, gunakan kode negara", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(VerifikasiPetaniActivity.this,"Kode Salah",Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        @Override
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(VerifikasiPetaniActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
    ...
    public void getdatauser(String no_telp){
        inboxQuery = rootref.child("petani").orderByChild("no_telp").equalTo(no_telp);
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (adsads.equals("asdfghj")){
                    Intent intent=new Intent(VerifikasiPetaniActivity.this, PetaniDaftarActivity.class);
                    intent.putExtra("no_telp",edtnohp.getText().toString());
                    startActivity(intent);
                    finish();
                }else {
                    Intent intent=new Intent(VerifikasiPetaniActivity.this,PetaniActivity.class);
                    intent.putExtra("no_telp",edtnohp.getText().toString());
                    startActivity(intent);
                    finish();
                }
